...
const environments = {
    "techoverflow-ta.aws.abnamro.org": {
        aws: {
            cognito: {
                region: "eu-west-1",
                userPoolId: "eu-west-1_z7zmkKXNL",
                userPoolWebClientId: "3mbj6opcbj65nb2vihun7eau5a",
    ...
    "techoverflow-d.aws.nl.eu.abnamro.com": {
        aws: {
            cognito: {
                region: "eu-west-1",
                userPoolId: "eu-west-1_49cJyX7ms",
                userPoolWebClientId: "4581pe4evn1t0ogfh2h3kbj2jt",
