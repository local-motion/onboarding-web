      ...
      <div className={classes.aboutUs}>
          ...
          <div className={classes.container}>
              <p className={classes.text}>
                  {'Rookvrijspelen is een initiatief van Longfonds. Wij streven ernaar dat elk kind dat vanaf 2017 wordt geboren Rookvrij kan opgroeien. Dat kan in een omgeving, zonder verleidingen en met goede voorbeelden om je heen. Hoe minder mensen je ziet roken, hoe minder vanzelfsprekend het wordt om zelf te gaan roken. Iedereen kan helpen met het Rookvrij maken van onze omgeving.'}
              </p>
              <p className={classes.text}>
