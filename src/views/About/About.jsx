          ...
          <div className={classes.mainDown}>
              <GridContainer className={"grid-container"}>
                  <GridItem xs={12} sm={12} md={6} className={classes.container}>
                      ...
                      Hoe meer mensen een speeltuin rookvrij willen hebben, hoe groter de kans dat het bestuur van de
                      speeltuinvereniging dit onderwerp op de agenda zet en hier mee aan de slag gaat.

                      <h3>Op weg naar een Rookvrije Generatie</h3>
                      Het rookvrij maken van speelplekken maakt deel uit van de beweging ‘op weg naar een Rookvrije
                      Generatie’. Deze beweging is een gezamenlijk initiatief van het Longfonds, KWF Kankerbestrijding
                      en de Hartstichting. In elke fase van het opgroeien willen we kinderen beschermen tegen tabaksrook
                      en de verleiding om te gaan roken. Zodat ze opgroeien als een generatie die zélf kan en zal kiezen
                      voor een gezonde, rookvrije toekomst.

                      <h3>Waarom is het zo belangrijk dat kinderen rookvrij kunnen spelen?</h3>
                      Iedereen wil dat kinderen spelen in een gezonde en veilige omgeving. Jonge longen zijn kwetsbaar.
                      Zien roken, doet roken. Als kinderen anderen zien roken, lijkt dat normaal en misschien zelfs
                      aantrekkelijk. Een rookvrije speeltuin geeft het goede voorbeeld aan kinderen.
                      <ul>
                          <li>Roken is de belangrijkste te voorkomen oorzaak van ziekte en sterfte in Nederland.</li>
                          <li>Roken is erg verslavend. Kinderen zijn extra gevoelig voor verslaving: hoe jonger je
                              begint met roken, hoe lastiger het is om te stoppen.
                          </li>
