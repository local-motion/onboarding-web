...
class DonateCard extends Component {
  ...
  changeAmount = ({ target: { name, value } }) =>
  ...
  getSubmitContent = () => {
    ...
    switch (submitLoading) {
      case null:
        return <div className={classes.submitText}>Submit</div>;
      case true:
        return <CircularProgress size={24} className={classes.submitLoading} />;
      case false: {
        if (redirectUrl) {
  ...
  renderTransactions = () => {
    ...
    return transactions.map(({ id, amount, inOut, time, name, note }) => (
            ...
            <div>
              <div className={classes.content}>
                ...
                <div className={classes.description}>
                  ...
                  <Typography component="p" className={classes.text}>
                    Vrijwilligers kunnen het geld uitgeven aan bovenstaande
                    producten. Indien het geld niet wordt uitgegeven kan het
                    gestort worden aan de Alliantie Nederland Rookvrij. Deze
                    keuze maak je wanneer je doneert.
                  </Typography>
                </div>
              </div>
              ...
              <div className={classes.tableWrapper}>
                <Table className={classes.table}>
                  ...
                  <TableBody>{this.renderTransactions()}</TableBody>
                </Table>
              </div>
              ...
              >
                <DialogContent className={classes.dialogContent}>
                  ...
                  >
                    ...
                    >
                      {banks.map(({ id, name, bic }) => (
                        <MenuItem key={id} value={bic}>
                          {name}
                        </MenuItem>
                      ))}
                    </Select>
                  ...
                  <div className={classes.checkboxes}>
                    <FormControlLabel
                      ...
                      classes={{
                        label: `${classes.checkbox} ${
                          isAnonymousDonation ? classes.checked : ''
                          }`
                      }}
                    ...
                    <FormControlLabel
                      ...
                      classes={{
                        label: `${classes.checkbox} ${
                          isMoneyToAnotherActie ? classes.checked : ''
                          }`
                      }}
                  ...
                  <Button
                    disabled={!!submitLoading || !!redirectUrl}
                    variant="outlined"
...
const mapDispatchToProps = dispatch => ({
  ...
  requestPayment: ({ id, amount, issuer, description }) =>
    dispatch(requestPayment({ id, amount, issuer, description }))
});
